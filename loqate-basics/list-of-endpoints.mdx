...
| Utilities	R| eturns any addresses matching a specific utility code | 
 
[See the Capture documentation](/api-reference/address-capture/address-capture-api-landing)
...
[See the Verify documentation](/api-reference/address-verify/address-verify-api-landing)
...
[See the Email Validation documentation](/api-reference/email-validation/email-validation-api-landing)
...
[See the Phone Validation documentation](/api-reference/phone-validation/phone-validation-api-landing)
...
[See the Bank Validation documentation](/api-reference/bank-validation/bank-validation-api-landing)
...
[See the Geocode documentation](/api-reference/geocode/geocode-api-landing)