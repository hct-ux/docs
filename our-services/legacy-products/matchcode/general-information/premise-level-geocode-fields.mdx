...
## Output Format
The Premise Level Geocode data is returned in the groupedAdditionalItems section of the [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures).
...
### Example Response
The following responses shows a [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures) record where the record contains a "PremiseLevelGeocode" group in the groupedAdditionalItems.
