...
The Matchcode Names service provides access to UK names information in a similar manner to Matchcode UK Address searching (see [Matchcode UK Address Integration Guide](http://localhost:3000/our-services/legacy-products/matchcode/integration-guides/matchcode-uk-address-integration-guide))
...
The **ProfileResponseDetails** structure contains a single [CaptureResponse](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#captureresponse) data structure which holds an array of [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataddress) records containing the returned address data.
...
| :--- | :--- | :--- | 
| BLPU_STATUS	| BLPU_STATUS	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuLogicalStatus | 
| BLPU_STATE	| BLPU_STATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuState | 
| BLPU_STATE_DATE	| BLPU_STATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuStateDate | 
| PARENT_UPRN	| PARENT_UPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → parentUprn | 
| X_COORDINATE	| X_COORDINATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → easting | 
| Y_COORDINATE	| Y_COORDINATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → northing | 
| RPC	| RPC	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → rpc | 
| BLPU_CUSTODIAN	| BLPU_CUSTODIAN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → localCustodianCode | 
| BLPU_START_DATE	| BLPU_START_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuStartDate | 
| BLPU_END_DATE	| BLPU_END_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuEndDate | 
| BLPU_UPDATE_DATE	| BLPU_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuLastUpdateDate | 
| BLPU_ENTRY_DATE	| BLPU_ENTRY_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → blpuEntryDate | 
| POSTAL_ADDRESS	| POSTAL_ADDRESS	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → postalAddressable | 
| POSTCODE_LOCATOR	| N/A	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → postcodeLocator | 
| MULTI_OCC_COUNT	| MULTI_OCC_COUNT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataBLPU](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatablpu) → multiOccCount | 
| CLASS_KEY	| CLASS_KEY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classKey | 
| CLASS_CODE	| CLASS_CODE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classificationCode | 
| CLASS_SCHEME	| CLASS_SCHEME	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classScheme | 
| CLASS_START_DATE	| CLASS_START_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classStartDate | 
| CLASS_END_DATE	| CLASS_END_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress)  → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification)  → classEndDate | 
| CLASS_UPDATE_DATE	| CLASS_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classLastUpdateDate | 
| CLASS_ENTRY_DATE	| CLASS_ENTRY_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → entryDate | 
| CLASS_PRIMARY	| CLASS_PRIMARY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classPrimaryText | 
| CLASS_SECONDARY	| CLASS_SECONDARY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classSecondaryText | 
| CLASS_TERTIARY	| CLASS_TERTIARY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classTertiaryText | 
| CLASS_QUATERNARY	| CLASS_QUATERNARY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataClassification](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataclassification) → classQuaternaryText | 
| LPI_KEY	| LPI_KEY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → lpiKey | 
| LANGUAGE	| LANGUAGE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → lpiLanguage | 
...
| LPI_START_DATE	| LPI_START_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → lpiStartDate | 
| LPI_END_DATE	| LPI_END_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → lpiEndDate | 
| LPI_UPDATE_DATE	| LPI_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → lpiLastUpdateDate | 
| LPI_ENTRY_DATE	| LPI_ENTRY_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → lpiEntryDate | 
...
| USRN	| USRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → usrn | 
| USRN_MATCH_INDI	| USRN_MATCH_INDI	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → usrnMatchIndicator | 
...
| LEVEL	| LEVEL	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → level | 
| OFFICIAL_FLAG	| OFFICIAL_FLAG	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataLPI](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatalpi) → officialFlag | 
...
| ST_LANGUAGE	| ST_LANGUAGE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetDescriptor](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetdescriptor) → streetLanguage | 
| ST_TYPE	| ST_TYPE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetType | 
| ST_NAMING_AUTH	| ST_NAMING_AUTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → swaOrgRefNaming | 
| ST_STATE	| ST_STATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetState | 
| ST_STATE_DATE	| ST_STATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → stateDate | 
| ST_SURFACE	| ST_SURFACE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetSurface | 
| ST_CLASS	| ST_CLASS	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetClassification | 
| ST_VERSION	| ST_VERSION	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetVersion | 
| ST_UPDATE_DATE	| ST_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetLastUpdateDate | 
| ST_ENTRY_DATE	| ST_ENTRY_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetEntryDate | 
| ST_START_DATE	| ST_START_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetStartDate | 
| ST_END_DATE	| ST_END_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetEndDate | 
| ST_START_X	| ST_START_X	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetStartEasting | 
| ST_START_Y	| ST_START_Y	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetStartNorthing | 
| ST_END_X	| ST_END_X	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetEndEasting | 
| ST_END_Y	| ST_END_Y	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation)  → streetEndNorthing | 
| ST_TOLERANCE	| ST_TOLERANCE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataStreetInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatastreetinformation) → streetTolerance | 
| ORG_ORGANISATION	| ORG_ORGANISATION	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataCompanyInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacompanyinformation) → organisationName | 
| ORG_LEGAL_NAME	| ORG_LEGAL_NAME	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataCompanyInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacompanyinformation) → legalOrganisationLegalName | 
| ORG_START_DATE	| ORG_START_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataCompanyInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacompanyinformation) → organisationStartDate | 
| ORG_END_DATE	| ORG_END_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataCompanyInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacompanyinformation) → organisationEndDate | 
| ORG_UPDATE_DATE	| ORG_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataCompanyInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacompanyinformation) → organisationLastUpdateDate | 
| ORG_ENTRY_DATE	| ORG_ENTRY_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataCompanyInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacompanyinformation) → organisationEntryDate | 
| UPRN	| UPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → uprn | 
| XREFMA	| XREFMA	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → osAl2Toid | 
| XREFMI	| XREFMI	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → osItnToid | 
| XREFMT	| XREFMT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → osTopoToid | 
| XREFVC	| XREFVC	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → voaCtRecord | 
| XREFVN	| XREFVN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → voaNdrRecord | 
