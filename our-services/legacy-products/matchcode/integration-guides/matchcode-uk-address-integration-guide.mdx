...
## Output Format
The results of the Addressbase Core web service search are returned in a [ProfileResponseDetails](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profileresponsedetails) structure with a **ProfileResponseDetail.responseType** of 'CAPTURE'.
...
| :--- | :--- | :--- | 
| PARENT_UPRN	| PARENT_UPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → parentUprn | 
| USRN	| USRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → usrn | 
| OS_ADDRESS_TOID	| OS_ADDRESS_TOID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → osAddressToid | 
| RPC	| RPC	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → rpc | 
| OS_COUNTRY	| OS_COUNTRY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → osCountry | 
...
| LAST_UPDATE_DATE	| LAST_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation)  → lastUpdateDate | 
| TOWN_NAME	| TOWN_NAME	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → townName | 
| PO_BOX	| PO_BOX	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → poBox | 
| GSS_ODE	| GSS_CODE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → gssCode | 
| ISLAND	| ISLAND	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → island | 
| X_COORDINATE	| X_COORDINATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → easting | 
| Y_COORDINATE	| Y_COORDINATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → northing | 
| OS_LATITUDE	| OS_LATITUDE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → latitude | 
| OS_LONGITUDE	| OS_LONGITUDE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → longitude | 
...
| UDPRN	| UDPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → rmUDPRN | 
