...
The input telephone information should be entered into the [IdMDataCaptureTelephone](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacapturetelephone) data structure:

**ExecuteCapture → [ProfileRequestCapture](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapture) → [ProfileRequestCaptureData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapturedata) → [IdMDataCaptureTelephone](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacapturetelephone)**

**Type: [IdMDataCaptureTelephone](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatacapturetelephone)**

| Field Name	| Type	| Description | 
| :--- | :--- | :--- | 
| number	| String	| Telephone Number (International format including dialing code e.g. +44) | 
| type	| EnumTelephone	| Specifies the type of telephone provided <br/><br/> MOBILE, LANDLINE, UNKNOWN | 
...
**ExecuteCapture → [ProfileRequestCapture](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapture) → [ProfileRequestCaptureData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapturedata) → [IdMDataSearchAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatasearchaddress) → countryCode**

## Additional Features
Additional information can be requested to be returned by providing the key value pairs specified below to the [ProfileRequestCaptureData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapturedata) → additionalData property.
...
This information should be entered into a [IdmDataArrayAdditionalData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataarrayadditionaldata) data structure:
...
| validationCodes	| [IdmDataArrayAdditionalData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataarrayadditionaldata)	| Array of key value pairs containing the validation response codes for the number | 
...
The validation results for each telephone number will be returned in the same order as input. The array of [ValidateResponse](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#validateresponse) data structures contain the individual response details. The primary response value is validityFlag which dictates whether or not the number has been deemed to be valid or not. In addition a series of key value pair response codes are returned for each number, which contain data supplier specific summaries of the input number.
