...
### Search Criteria
The Eircode search criteria should be entered into the [IdmDataSearchAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatasearchaddress) data structure, which is located within the input details as follows:
...
## Output Format
The results of the Eircode web service search are returned in a [ProfileResponseDetails](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profileresponsedetails) structure with a **ProfileResponseDetail.responseType** of 'CAPTURE'.
...
Additional data from a search may be returned in the [additionalItems](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataarrayadditionaldata) of the [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress).
...
| :--- | :--- | :--- | 
| ECAF_ID	| ECAF_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ECAF_ID | 

### ECAD Specific
| Field	| Related Data Item Key	| Location In Response | 
| :--- | :--- | :--- | 
| ECAD_ID	| ECAD_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ECAD_ID | 
| LA_ID	| LA_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → LA_ID | 
| DED_ID	| DED_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → DED_ID | 
| SMALL_AREA_| ID	SMALL_AREA_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → SMALL_AREA_ID | 
| TOWNLOAND_ID	| TOWNLOAND_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → TOWNLOAND_ID  | 
| ADMIN_GAELTACHT	| ADMIN_GAELTACHT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ADMIN_GAELTACHT  | 
| NUA	| NUA	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → NUA | 
| BUILDING_ID	| BUILDING_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → BUILDING_ID | 
| BUILDING_TYPE_ID	| BUILDING_TYPE_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → BUILDING_TYPE_ID  | 
| HOLIDAY_HOME	| HOLIDAY_HOME	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → HOLIDAY_HOME | 
| UNDER_CONS	| UNDER_CONS	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → UNDER_CONS | 
| BUILDING_USE	| BUILDING_USE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → BUILDING_USE | 
| BLD_VACANT	| BLD_VACANT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → BLD_VACANT | 
| ING_EAST	| ING_EAST	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ING_EAST | 
| ING_NORTH	| ING_NORTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ING_NORTH | 
| ITM_EAST	| ITM_EAST	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ITM_EAST | 
| ITM_NORTH	| ITM_NORTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ITM_NORTH | 
| ETRS89_LAT	| ETRS89_LAT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ETRS89_LAT | 
| ETRS89_LONG	| ETRS89_LONG	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ETRS89_LONG | 
| ING_MIN_EAST	| ING_MIN_EAST	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ING_MIN_EAST | 
| ING_MIN_NORTH	| ING_MIN_NORTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ING_MIN_NORTH | 
| ING_MAX_EAST	| ING_MAX_EAST	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ING_MAX_EAST | 
| ING_MAX_NORTH	| ING_MAX_NORTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ING_MAX_NORTH | 
| ITM_MIN_EAST	| ITM_MIN_EAST	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ITM_MIN_EAST | 
| ITM_MIN_NORTH	| ITM_MIN_NORTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ITM_MIN_NORTH | 
| ITM_MAX_EAST	| ITM_MAX_EAST	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ITM_MAX_EAST | 
| ITM_MAX_NORTH	| ITM_MAX_NORTH	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ITM_MAX_NORTH | 
| ETRS89_MIN_LAT	| ETRS89_MIN_LAT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress)s → additionalItems → ETRS89_MIN_LAT | 
| ETRS89_MIN_LONG	| ETRS89_MIN_LONG	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ETRS89_MIN_LONG | 
| ETRS89_MAX_LAT	| ETRS89_MAX_LAT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ETRS89_MAX_LAT | 
| ETRS89_MAX_LONG	| ETRS89_MAX_LONG	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ETRS89_MAX_LONG | 
| SPATIAL_ACCURACY	| SPATIAL_ACCURACY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → SPATIAL_ACCURACY | 
| BLD_TYPE_NAME	| BLD_TYPE_NAME	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → BLD_TYPE_NAME | 
| BLD_TYPE_CODE	| BLD_TYPE_CODE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → BLD_TYPE_CODE | 
| ORGANISATION_ID	| ORGANISATION_ID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ORGANISATION_ID | 
| ORG_VACANT	| ORG_VACANT	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → ORG_VACANT | 
| NACE_CODE	| NACE_CODE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → NACE_CODE | 
| NACE_CATEGORY	| NACE_CATEGORY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → additionalItems → NACE_CATEGORY |  
