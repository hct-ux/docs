...
**ExecuteCapture → [ProfileRequestCapture](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapture) → [ProfileRequestCaptureData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profilerequestcapturedata) → [IdMDataSearchAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress)**
...
To do this use the [IdMDataSearchAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataSearchUtilitiesInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatasearchutilitiesinformation) structure.
...
```
### Output Details
The results of the Utilities Register web service search are returned in a [ProfileResponseDetails](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profileresponsedetails) structure with a **ProfileResponseDetail.responseType** of 'CAPTURE'.
...
**ExecuteCaptureResponse > [ProfileResponse](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profileresponse) [0] > [ProfileResponseDetails](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#profileresponsedetails) [0] > [CaptureResponse](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#captureresponse) > [CaptureResponseData](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#captureresponsedata) > [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) [n]**

## Utilities Register Information
The Utilities Register specific business information is returned in the [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress) → [IdmDataUtilitiesInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatautilitiesinformation) structure

## Additional Information
Additional information may be returned in the [additionalItems](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataarrayadditionaldata) of the [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddress).
