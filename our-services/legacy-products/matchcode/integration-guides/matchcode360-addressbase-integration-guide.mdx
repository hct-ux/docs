...
The Matchcode AddressBase Core service provides access to the AddressBase Core data, in a similar manner to Matchcode UK Address searching (see [Matchcode UK Address Integration Guide](http://localhost:3000/our-services/legacy-products/matchcode/integration-guides/address-web-service-integration-guide)). 
...
## Congestion Zone
The congestion zone dataset is detailed [here](http://localhost:3000/our-services/legacy-products/matchcode/general-information/location-intelligence-fields).

## Red Route
The red route dataset is detailed [here](http://localhost:3000/our-services/legacy-products/matchcode/general-information/location-intelligence-fields).
...
## Output Format
The results of the Addressbase Core web service search are returned in a [ProfileResponseDetails](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#profileresponsedetails) structure with a **ProfileResponseDetail.responseType** of 'CAPTURE'.

The **ProfileResponseDetails** structure contains a single [CaptureResponse](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#captureresponse) data structure which holds an array of [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) records containing the returned address data.

**ExecuteCaptureResponse > ProfileResponse [0] > ProfileResponseDetails [0] > CaptureResponse > CaptureResponseData > IdmDataAddress [n]**

Additional data from a search may be returned in the [additionalItems](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#additionalitems) or the [groupedAdditionalItems](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataadditionaldatagroup) of the [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress).
...
| :--- | :--- | :--- | 
| PARENT_UPRN	| PARENT_UPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → parentUprn | 
| USRN	| USRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → usrn | 
| OS_ADDRESS_TOID	| OS_ADDRESS_TOID	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → osAddressToid | 
| RPC	| RPC	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → rpc | 
| OS_COUNTRY	| OS_COUNTRY	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → osCountry | 
| OS_CLASS	| OS_CLASS	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → osClass | 
| LAST_UPDATE_DATE	| LAST_UPDATE_DATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation)  → lastUpdateDate | 
| TOWN_NAME	| TOWN_NAME	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → townName | 
| PO_BOX	| PO_BOX	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → poBox | 
| GSS_ODE	| GSS_CODE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → gssCode | 
| ISLAND	| ISLAND	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataAddressBaseCoreInformation](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdataaddressbasecoreinformation) → island | 
| X_COORDINATE	| X_COORDINATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → easting | 
| Y_COORDINATE	| Y_COORDINATE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → northing | 
| OS_LATITUDE	| OS_LATITUDE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → latitude | 
| OS_LONGITUDE	| OS_LONGITUDE	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → [IdmDataGeographic](http://localhost:3000/our-services/legacy-products/matchcode/general-information/idm-data-structures#idmdatageographic) → longitude | 
| UPRN	| UPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → uprn | 
| UDPRN	| UDPRN	| [IdmDataAddress](http://localhost:3000/our-services/legacy-products/matchcode/general-information/address-filters#idmdataaddress) → rmUDPRN | 
